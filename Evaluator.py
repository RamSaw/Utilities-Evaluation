...
def main():
    dataset_root_path = "/home/mikhail/Documents/Development/UtilitiesEvaluation/testDataset/projects/"
    write_result_to_file("./evaluation_result", Evaluator.evaluate(dataset_root_path))
